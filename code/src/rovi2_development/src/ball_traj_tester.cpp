...
int main(int argc, char  *argv[]) {
    ...
    while (ros::ok())
    {
      ...
      pos_noisy.point.x = pos.point.x + random() % 1000 / 1000. -  1000 / 2000.;
      pos_noisy.point.y = pos.point.y + random() % 1000 / 1000. -  1000 / 2000.;
      pos_noisy.point.z = pos.point.z + random() % 1000 / 1000. -  1000 / 2000.;
